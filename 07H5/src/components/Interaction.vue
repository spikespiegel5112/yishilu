        ...
        <ul>
          <li class="yan" @click="receivetask(1)">
            <a href="javascript:;">
              <img
                class="disabled"
                src="@/image/interaction/button_interaction_yan_00000.png"
                alt
              />
              <img
                :class="yan_enabled"
          ...
          <li class="shi" @click="receivetask(2)">
            <a href="javascript:;">
              <img
                class="disabled"
                src="@/image/interaction/button_interaction_shi_00000.png"
                alt
              />
              <img
                :class="shi_enabled"
          ...
          <li class="guang" @click="receivetask(3)">
            <a href="javascript:;">
              <img
                class="disabled"
                src="@/image/interaction/button_interaction_guang_00000.png"
                alt
              />
              <img
                :class="guang_enabled"
...
export default {
  ...
  methods: {
    ...
    getlighten() {
      //获取用户点亮的任务
      this.$http
        .get(this.$baseUrl + this.getLightenRequest, {
    ...
    checkStatus() {
      if (
        this.yan_enabled == "disabled" &&
        this.shi_enabled == "disabled" &&
        this.guang_enabled == "disabled"
      ) {
        this.$router.push({
          name: "lotteryDraw",
        });
