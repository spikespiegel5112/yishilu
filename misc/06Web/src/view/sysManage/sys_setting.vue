  ...
  <Card style="width:50%;margin:0 auto">
    <Form :model="formItem" ref="formValidate" :rules="ruleValidate" :label-width="200">
     <FormItem label="主图1:" class="uploadList">
              <div class="demo-upload-list" v-show="this.ImgStatus_Main_1 === 'finished'">
      ...
      <FormItem label="主图2:" class="uploadList">
              <div class="demo-upload-list" v-show="this.ImgStatus_Main_2 === 'finished'">
       ...
       <FormItem label="主图3:" class="uploadList">
              <div class="demo-upload-list" v-show="this.ImgStatus_Main_3 === 'finished'">
       ...
       <FormItem label="中奖图:" class="uploadList">
              <div class="demo-upload-list" v-show="this.ImgStatus_Draw_Img === 'finished'">
       ...
       <FormItem label="评选图:" class="uploadList">
              <div class="demo-upload-list" v-show="this.ImgStatus_Selection_Img === 'finished'">
                <img :src="formItem.selection_Img" style="width:50px;height:50px" />
                <div class="demo-upload-list-cover">
                  <Icon
                    type="ios-eye-outline"
       ...
       <FormItem label="尾图" class="uploadList">
              <div class="demo-upload-list" v-show="this.ImgStatus_Last_Img === 'finished'">
      ...
      <FormItem label="红包金额"  prop="red_Envelopes">
        <Input style="width:50%" :number="true"  v-model="formItem.red_Envelopes" placeholder="请输入红包金额"></Input>元
      </FormItem>
      <FormItem>
  ...
  methods: {
   ...
   ImgSuccess_Main_1(res) {
    ...
    sendparameter(){
          var _this = this;
          _this.$axios
            .post("add.update.setting", _this.formItem)
            .then(p => {
              if (p.data.state == 200) {
